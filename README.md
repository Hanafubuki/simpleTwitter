...
5. Make a copy of .env.example file and create a new file as .env
6. Create a database named "linkx" inside your MySQL Database *
//7. php artisan migrate
7. composer run-script first-initialization
8. php artisan serve
